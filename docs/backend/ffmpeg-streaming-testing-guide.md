...
export default function TestPage() {
  return (
    <div className="container mx-auto p-8">
      ...
      <SmartVideoPlayer path="Movies/test.mp4" showStreamInfo />
    </div>
  );
}
```
...
```tsx
<SmartVideoPlayer path="Movies/test.mkv" showStreamInfo />
```
...
export default function TestPage() {
  ...
  return (
    <div className="p-8">
      ...
      <SmartVideoPlayer path="Movies/test.mkv" quality={quality} showStreamInfo />
    </div>
  );
}
```
